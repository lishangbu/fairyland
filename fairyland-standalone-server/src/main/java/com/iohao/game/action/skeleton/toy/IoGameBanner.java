...
public final class IoGameBanner {
    ...
    public static void println19(Object message) {
        out.println(message);
    }

    public static void println19(String message) {
        out.println(message);
    }
        ...
        Runnable runnable = () -> {
            ...
            try {
                if (Objects.nonNull(IoGameBanner.me().countDownLatch)) {
                    ...
                    if (!r) {
                        IoGameBanner.println19("countDownLatch await is false");
                    }
                }
    ...
    private void extractedPrint(ToyTable table) {
        ...
        IoGameBanner.println19();
        IoGameBanner.println19(anyBanner);
        table.render();
    }
